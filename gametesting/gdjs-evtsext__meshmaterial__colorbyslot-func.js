...
gdjs.evtsExt__MeshMaterial__ColorBySlot.userFunc0xec0ed8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length > 0) {
...
var objects = [];
objects.push.apply(objects,gdjs.evtsExt__MeshMaterial__ColorBySlot.GDObjectObjects1);
gdjs.evtsExt__MeshMaterial__ColorBySlot.userFunc0xec0ed8(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
