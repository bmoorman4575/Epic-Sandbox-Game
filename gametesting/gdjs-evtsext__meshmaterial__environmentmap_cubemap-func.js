...
if (typeof gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap !== "undefined") {
  gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap = {};
gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.GDObjectObjects1= [];


gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.userFunc0xf7c270 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length > 0) {
...
gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
var objects = [];
objects.push.apply(objects,gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.GDObjectObjects1);
gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.userFunc0xf7c270(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.func = function(runtimeScene, Object, PX, NX, PZ, NZ, PY, NY, parentEventsFunctionContext) {
...
gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.GDObjectObjects1.length = 0;

gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.eventsList0(runtimeScene, eventsFunctionContext);

return;
}

gdjs.evtsExt__MeshMaterial__EnvironmentMap_Cubemap.registeredGdjsCallbacks = [];