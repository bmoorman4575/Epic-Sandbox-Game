...
gdjs.evtsExt__MeshMaterial__AffectedByFog.userFunc0xf4e5a0 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length > 0) {
...
var objects = [];
objects.push.apply(objects,gdjs.evtsExt__MeshMaterial__AffectedByFog.GDObjectObjects1);
gdjs.evtsExt__MeshMaterial__AffectedByFog.userFunc0xf4e5a0(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
